...
(function($){
	...
	$(this).hover(function(ee){
		var imageLeft = $(this).get(0).offsetLeft;
		var imageRight = $(this).get(0).offsetRight;
		var mouseHeight = new MouseEvent(ee).y;
		var imageCTop =  $(this).get(0).clientTop;
		var imageTop = $(this).get(0).offsetTop;
		var imageWidth = $(this).get(0).offsetWidth;
		var imageHeight = $(this).get(0).offsetHeight;
		//alert(imageTop+","+imageCTop+","+mouseHeight+","+imageHeight+","+$("div.zxx_main_con").height()/2);
		imageTop = imageTop>imageHeight*2?imageTop-imageHeight:imageTop;
		...
		$("span.zxx_image_zoom_div").show();
			...
			scrolly = mouse.y  - ($("span.zxx_image_zoom_div").height()*1/scaley)/2 ;
